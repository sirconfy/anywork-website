    ...
    <section className="px-4 md:px-0 py-16 flex justify-center">
      <div className="bg-[#262C2F] rounded-[32px] px-8 md:px-40 py-12 text-center max-w-4xl w-full">
        ...
        <p className="text-gray-400 text-sm md:text-[18px] font-[400] mb-8">
          Join thousands of satisfied customers and trusted artisans on
          Nigeria&apos;s leading service marketplace.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button className="border border-secondary text-secondary  cursor-pointer px-6 py-2 rounded-md font-medium transition ">
            Become a worker
          </button>
        </div>
      </div>
